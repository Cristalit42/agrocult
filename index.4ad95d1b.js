...
document.addEventListener("DOMContentLoaded", ()=>{
    const accItems = document.querySelectorAll(".services__acc-item");
    accItems.forEach((item)=>{
        const head = item.querySelector(".js-acc__head");
        head.addEventListener("click", ()=>{
            // Если элемент уже активен, убираем модификатор
            if (item.classList.contains("services__acc-item--active")) {
                item.classList.remove("services__acc-item--active");
                return;
            }
            // Убираем модификатор со всех остальных элементов
            accItems.forEach((el)=>el.classList.remove("services__acc-item--active"));
            // Добавляем модификатор к текущему элементу
            item.classList.add("services__acc-item--active");
        });
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    const overlay = document.querySelector('.js-overlay_list');
    ...
    const overlayBtnClose = document.querySelector('.js-overlay__btn');
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    const burberBtn = document.querySelectorAll('.js__burger-btn');
...
let $e5436bce16ba966d$var$swiperInstance;
function $e5436bce16ba966d$var$initSwiper() {
    if (window.innerWidth < 1050 && !$e5436bce16ba966d$var$swiperInstance) $e5436bce16ba966d$var$swiperInstance = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)('.achievements__swiper', {
        modules: [
    ...
    else if (window.innerWidth >= 1050 && $e5436bce16ba966d$var$swiperInstance) {
        $e5436bce16ba966d$var$swiperInstance.destroy(true, true);
        $e5436bce16ba966d$var$swiperInstance = null;
    }
}
$e5436bce16ba966d$var$initSwiper();
window.addEventListener('resize', $e5436bce16ba966d$var$initSwiper);
